...
ggplot(results, aes(x = n, y = area_name, colour = mode)) +
  ...
  labs(x = NULL, y = NULL, colour = NULL,
       title = "Road casualties by ward and mode of travel in Trafford, 2016",
  ...
  theme(plot.margin = unit(c(3, 2, 2, 2), "cm"),
        ...
        plot.title = element_text(face = "bold", vjust = 10, hjust = 0),
...
# save plot / data  ---------------------------
ggsave(file = "dot_chart.png", scale = 1.5, width = 10, height = 5)
