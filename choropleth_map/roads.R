...
ggplot() +
  ...
  scale_colour_manual(breaks = 1:10,
                      ...
                      labels = c("Most \ndeprived", 2:9, "Least \n deprived")) +
  labs(x = NULL, y = NULL, 
       title = "Deprivation in Trafford by LSOA: roads", 
...
# save plot  ---------------------------
#ggsave(file = "IMD_2015_choropleth_map_roads.svg", dpi = 300, width = 6, height = 6)
ggsave(file = "IMD_2015_choropleth_map_roads.png", dpi = 300, width = 6, height = 6)
